...
module.exports = class Migrations1730285117518 {
    name = 'Migrations1730285117518'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`identifier\` varchar(255) NOT NULL, \`license\` varchar(255) NOT NULL, \`steamId\` varchar(255) NULL, \`ip\` varchar(255) NULL, \`lastConnection\` timestamp NULL, \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`username\` varchar(255) NOT NULL, \`active\` tinyint NOT NULL DEFAULT 0, UNIQUE INDEX \`IDX_a3ffb1c0c8416b9fc6f907b743\` (\`id\`), UNIQUE INDEX \`IDX_2e7b7debda55e0e7280dc93663\` (\`identifier\`), UNIQUE INDEX \`IDX_ab0251a0d0c1d7ab463e83712f\` (\`license\`), UNIQUE INDEX \`IDX_0827cd828b990ba2a928ac5fd2\` (\`steamId\`), UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), UNIQUE INDEX \`IDX_fe0bb3f6520ee0469504521e71\` (\`username\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_ab0251a0d0c1d7ab463e83712f\` ON \`users\``);
