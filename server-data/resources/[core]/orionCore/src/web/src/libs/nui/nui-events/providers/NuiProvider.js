...
function getParams(resource, event, data) {
    return [
        "https://".concat(resource, "/").concat(event),
        {
            method: "post",
            headers: {
...
var NuiProvider = function (_a) {
    ...
    var resourceRef = (0, react_1.useRef)(resource || "");
    var timeoutRef = (0, react_1.useRef)(timeout || DEFAULT_TIMEOUT);
    var eventListener = function (event) {
        var _a = event.data, app = _a.app, method = _a.method, data = _a.data;
        if (app && method) {
            window.dispatchEvent(new MessageEvent((0, eventNameFactory_1.eventNameFactory)(app, method), {
                data: data,
            }));
        }
    };
    ...
    var send = (0, react_1.useCallback)(function (event_1) {
        var args_1 = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args_1[_i - 1] = arguments[_i];
        }
        return __awaiter(void 0, __spreadArray([event_1], args_1, true), void 0, function (event, data, res) {
            if (data === void 0) { data = {}; }
    ...
    var sendAbortable = (0, react_1.useCallback)(function (event, data, res) {
        if (data === void 0) { data = {}; }
        return abortableFetch.apply(void 0, getParams(res || resourceRef.current, event, data));
    }, []);
    return ((0, jsx_runtime_1.jsx)(NuiContext_1.NuiContext.Provider, { value: {
            send: send,
